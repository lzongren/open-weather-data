...
public class Coordinate extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Coordinate(java.lang.Double lon, java.lang.Double lat) {
    this.lon = lon;
    this.lat = lat;
  }
   ...
   */
  public static com.zliu.schema.Coordinate.Builder newBuilder() {
    return new com.zliu.schema.Coordinate.Builder();
  }
   ...
   * @return A new Coordinate RecordBuilder
   */
  public static com.zliu.schema.Coordinate.Builder newBuilder(com.zliu.schema.Coordinate.Builder other) {
    return new com.zliu.schema.Coordinate.Builder(other);
  }
   ...
   * @return A new Coordinate RecordBuilder
   */
  public static com.zliu.schema.Coordinate.Builder newBuilder(com.zliu.schema.Coordinate other) {
    return new com.zliu.schema.Coordinate.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Coordinate>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.zliu.schema.Coordinate.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.zliu.schema.Coordinate other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.lon)) {
        this.lon = data().deepCopy(fields()[0].schema(), other.lon);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Coordinate.Builder setLon(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Coordinate.Builder clearLon() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Coordinate.Builder setLat(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Coordinate.Builder clearLat() {
