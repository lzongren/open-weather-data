...
public class Main extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Main(java.lang.Double temp, java.lang.Double pressure, java.lang.Double humidity, java.lang.Double temp_min, java.lang.Double temp_max) {
    this.temp = temp;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: temp = (java.lang.Double)value$; break;
    case 1: pressure = (java.lang.Double)value$; break;
    case 2: humidity = (java.lang.Double)value$; break;
    case 3: temp_min = (java.lang.Double)value$; break;
    case 4: temp_max = (java.lang.Double)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setHumidity(java.lang.Double value) {
    this.humidity = value;
  }
   ...
   */
  public java.lang.Double getTempMin() {
    return temp_min;
  }
   ...
   * @param value the value to set.
   */
  public void setTempMin(java.lang.Double value) {
    this.temp_min = value;
  }
   ...
   */
  public java.lang.Double getTempMax() {
    return temp_max;
  }
   ...
   * @param value the value to set.
   */
  public void setTempMax(java.lang.Double value) {
    this.temp_max = value;
  }
   ...
   */
  public static com.zliu.schema.Main.Builder newBuilder() {
    return new com.zliu.schema.Main.Builder();
  }
   ...
   * @return A new Main RecordBuilder
   */
  public static com.zliu.schema.Main.Builder newBuilder(com.zliu.schema.Main.Builder other) {
    return new com.zliu.schema.Main.Builder(other);
  }
   ...
   * @return A new Main RecordBuilder
   */
  public static com.zliu.schema.Main.Builder newBuilder(com.zliu.schema.Main other) {
    return new com.zliu.schema.Main.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Main>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.zliu.schema.Main.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.zliu.schema.Main other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.temp)) {
        this.temp = data().deepCopy(fields()[0].schema(), other.temp);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Main.Builder setTemp(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Main.Builder clearTemp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Main.Builder setPressure(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Main.Builder clearPressure() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Main.Builder setHumidity(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Main.Builder clearHumidity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Main.Builder setTempMin(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Main.Builder clearTempMin() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Main.Builder setTempMax(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Main.Builder clearTempMax() {
    ...
    public Main build() {
      try {
        ...
        record.temp = fieldSetFlags()[0] ? this.temp : (java.lang.Double) defaultValue(fields()[0]);
        record.pressure = fieldSetFlags()[1] ? this.pressure : (java.lang.Double) defaultValue(fields()[1]);
        record.humidity = fieldSetFlags()[2] ? this.humidity : (java.lang.Double) defaultValue(fields()[2]);
        record.temp_min = fieldSetFlags()[3] ? this.temp_min : (java.lang.Double) defaultValue(fields()[3]);
        record.temp_max = fieldSetFlags()[4] ? this.temp_max : (java.lang.Double) defaultValue(fields()[4]);
        return record;
      } catch (Exception e) {
