...
public class Sys extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Sys(java.lang.Double type, java.lang.Double id, java.lang.Double message, java.lang.CharSequence country, java.lang.Double sunrise, java.lang.Double sunset) {
    this.type = type;
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: type = (java.lang.Double)value$; break;
    case 1: id = (java.lang.Double)value$; break;
    case 2: message = (java.lang.Double)value$; break;
    case 3: country = (java.lang.CharSequence)value$; break;
    case 4: sunrise = (java.lang.Double)value$; break;
    case 5: sunset = (java.lang.Double)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public void setType(java.lang.Double value) {
    this.type = value;
  }
   ...
   * @param value the value to set.
   */
  public void setMessage(java.lang.Double value) {
    this.message = value;
  }
   ...
   */
  public java.lang.Double getSunrise() {
    return sunrise;
  }
   ...
   * @param value the value to set.
   */
  public void setSunrise(java.lang.Double value) {
    this.sunrise = value;
  }
   ...
   */
  public java.lang.Double getSunset() {
    return sunset;
  }
   ...
   * @param value the value to set.
   */
  public void setSunset(java.lang.Double value) {
    this.sunset = value;
  }
   ...
   */
  public static com.zliu.schema.Sys.Builder newBuilder() {
    return new com.zliu.schema.Sys.Builder();
  }
   ...
   * @return A new Sys RecordBuilder
   */
  public static com.zliu.schema.Sys.Builder newBuilder(com.zliu.schema.Sys.Builder other) {
    return new com.zliu.schema.Sys.Builder(other);
  }
   ...
   * @return A new Sys RecordBuilder
   */
  public static com.zliu.schema.Sys.Builder newBuilder(com.zliu.schema.Sys other) {
    return new com.zliu.schema.Sys.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Sys>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.zliu.schema.Sys.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.zliu.schema.Sys other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder setType(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder clearType() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder setId(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder setMessage(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder clearMessage() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder setCountry(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder clearCountry() {
      country = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder setSunrise(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder clearSunrise() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder setSunset(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zliu.schema.Sys.Builder clearSunset() {
    ...
    public Sys build() {
      try {
        Sys record = new Sys();
        record.type = fieldSetFlags()[0] ? this.type : (java.lang.Double) defaultValue(fields()[0]);
        record.id = fieldSetFlags()[1] ? this.id : (java.lang.Double) defaultValue(fields()[1]);
        record.message = fieldSetFlags()[2] ? this.message : (java.lang.Double) defaultValue(fields()[2]);
        record.country = fieldSetFlags()[3] ? this.country : (java.lang.CharSequence) defaultValue(fields()[3]);
        record.sunrise = fieldSetFlags()[4] ? this.sunrise : (java.lang.Double) defaultValue(fields()[4]);
        record.sunset = fieldSetFlags()[5] ? this.sunset : (java.lang.Double) defaultValue(fields()[5]);
        return record;
      } catch (Exception e) {
